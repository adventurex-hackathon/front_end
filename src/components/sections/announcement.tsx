export const Announcement = () => (
  <section>
    <div className="overflow-hidden border-b border-white/20 bg-gradient-to-r from-indigo-900 to-sky-900 px-2 py-1.5">
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <svg
          fill="none"
          viewBox="0 0 848 513"
          className="absolute right-1/2 h-[513px] w-[848px] translate-x-[235px] translate-y-[-90px] sm:hidden"
        >
          <path
            fill="#fff"
            fillOpacity="0.1"
        ...
        <svg
          fill="none"
          viewBox="0 0 848 513"
          className="absolute right-1/2 hidden h-[513px] w-[848px] translate-x-[-150px] translate-y-[-250px] sm:block"
        >
          <path
            fill="#fff"
            fillOpacity="0.1"
        ...
        <svg
          fill="none"
          viewBox="0 0 848 513"
          className="absolute left-1/2 hidden h-[513px] w-[848px] translate-x-[330px] translate-y-[-357px] sm:block"
        >
          <path
            fill="#fff"
            fillOpacity="0.1"
      ...
      <div className="relative z-50">
        <div className="text-center">
          <a className="inline-block w-full text-xs font-medium text-white transition-colors hover:text-gray-200 sm:text-sm">
            <span className="font-bold">What do you want to learn? &rarr;</span>
          </a>
        </div>
      </div>
    </div>
