  ...
  return (
    ...
    >
      <div className="relative mx-5 border-x md:mx-10">
        {/* Decorative borders */}
        <div className="absolute top-0 -left-4 h-full w-4 [background-image:repeating-linear-gradient(315deg,currentColor_0_1px,#0000_0_50%)] bg-[size:10px_10px] text-gray-950/5 md:-left-14 md:w-14"></div>
        <div className="absolute top-0 -right-4 h-full w-4 [background-image:repeating-linear-gradient(315deg,currentColor_0_1px,#0000_0_50%)] bg-[size:10px_10px] text-gray-950/5 md:-right-14 md:w-14"></div>
