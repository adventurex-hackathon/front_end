  ...
  <main className="relative flex flex-col">
    ...
    <div className="mt-20 border-y border-dashed border-foreground/10 py-2 md:mt-24 lg:mt-28">
      <div className="container">
        <h1>
          The 100x <br className="hidden sm:block" />
          Learning Platform making <br className="hidden sm:block" />
          Hard Topics Easy
        </h1>
        <div className="mt-8 max-w-lg text-gray-700 dark:text-gray-300 md:max-w-xl">
          <p className="mb-6">
            Turn complex documents and codebases into bite-sized, interconnected
            video explainers—built for students, teachers, and vibe coders for
            every language.
          </p>
          <p>
            From dense math proofs to sprawling code bases, Visocode createsw a
            densely connected graph of digestable videos that make deep
            understanding visual and intuitive.
          </p>
        </div>
