...
export const siteConfig = {
  name: "VisoCode",
  description:
    "AI-powered explainer engine that converts questions into expert-level animated videos.",
  cta: "Generate Video",
  ...
  testimonials: [
    {
      ...
      description: (
        <p>
          VisoCode helped me understand complex algorithms in minutes instead of
          hours.
          <Highlight>
    ...
    },
    {
      ...
      description: (
        <p>
          I use VisoCode to create engaging lecture materials for my calculus
          classes.
          <Highlight>Student engagement has increased by 75%!</Highlight> The
          LaTeX rendering is flawless.
        </p>
      ),
    },
    {
    ...
    },
    {
      ...
      description: (
        <p>
          My students finally understand quantum mechanics thanks to
          VisoCode&apos;s animated explanations.
    ...
    },
    {
      ...
      description: (
        <p>
          VisoCode helps our team document complex system architectures in an
          accessible way.
          <Highlight>
    ...
    },
    {
      ...
      description: (
        <p>
          ...
          <Highlight>Course completion rates increased by 85%.</Highlight>{" "}
    ...
    },
    {
      ...
      description: (
        <p>
          ...
          <Highlight>
            Students engage more with visual learning materials.
          </Highlight>
    ...
    },
    {
      ...
      description: (
        <p>
          As someone learning to code independently, VisoCode&apos;s
          explanations made complex concepts accessible.
          <Highlight>
